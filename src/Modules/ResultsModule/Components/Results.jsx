        ...
        <div className="w-11/12 mx-auto py-5">
          <div className="flex justify-between items-center ">
            ...
            <div className="relative md:w-1/3 w-full ">
              ...
              <Input
                className="w-full py-6 pl-10 rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 placeholder:text-black dark:placeholder:text-gray-400 placeholder:text-lg text-black dark:text-white"
            ...
            <Table className="border border-gray-200 dark:border-gray-600 p-5 rounded-lg ">
              ...
              <TableBody>
                {loading ? (
                  ...
                  filtered.map((result) => (
                    <TableRow
                      className="text-center tracking-widest py-5 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700"
                      key={result.quiz._id}
                      onClick={() =>
                    ...
                    >
                      <TableCell className="font-medium tracking-widest py-5 text-black dark:text-gray-100">
                        {result.quiz.title}
                      </TableCell>
                      ...
                      <TableCell className="text-center tracking-widest py-5 text-black dark:text-gray-100">
                      ...
                      <TableCell className="text-center tracking-widest px-4 py-5 text-black text-gray-100">
